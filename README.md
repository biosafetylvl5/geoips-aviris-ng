...
I welcome contributions to geoips-aviris-ng!
...
6.  **Open a Pull Request** against the `main` (or `dev`) branch of the `biosafetylvl5/geoips-aviris-ng` repository.
...
2.  Clone the repository: `git clone https://github.com/biosafetylvl5/geoips-aviris-ng.git`
...
3.  **Clone the repository**:
    ```bash
    git clone https://github.com/biosafetylvl5/geoips-aviris-ng.git
    cd geoips-aviris-ng
    ```
